...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "products" ADD CONSTRAINT "products_product_file_id_product_files_id_fk" FOREIGN KEY ("product_file_id") REFERENCES "public"."product_files"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "products_product_file_idx" ON "products" USING btree ("product_file_id");
